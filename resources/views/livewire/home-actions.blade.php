<div x-data="{songArtists: false, rateSong: false, artistSongs:false}">
    <div class="container mx-auto px-5">
        <div class="bg-white p-8 rounded-md w-full">
            <div class=" flex items-center justify-between pb-6">
                <div>
                    <h2 class="text-gray-600 font-semibold">Top 10 Songs</h2>
                </div>
                <div class="flex items-center justify-between">
                    <div class="lg:ml-40 ml-10 space-x-8">
                        <a href="{{secure_url('songs/create')}}" class="bg-indigo-600 px-4 py-2 rounded-md text-white font-semibold
    ...
    <div class="container mx-auto px-5 pt-20">
        <div class="bg-white p-8 rounded-md w-full">
            <div class=" flex items-center justify-between pb-6">
                <div>
                    <h2 class="text-gray-600 font-semibold">Top 10 Artists</h2>
                </div>
                <div class="flex items-center justify-between">
                    <div class="lg:ml-40 ml-10 space-x-8">
