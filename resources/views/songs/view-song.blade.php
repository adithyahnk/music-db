    ...
    <div class="min-h-[87vh]">
        ...
        <div class="mt-10">
            <div class="max-w-7xl bg-gray-50 rounded shadow mx-auto py-6 px-4 sm:px-6 lg:px-8">
                <a href="{{url('songs/'.$song->id.'/edit')}}" class="float-right">
                ...
                <div class="bg-opacity-25 gap-4 grid grid-cols-1 md:grid-cols-2">
                    ...
                    <div>
                        ...
                        <p>{{\Carbon\Carbon::parse($song->release_date)->format('M d, Y')}}</p>
                    </div>
                </div>
                <div class="mt-7">
                ...
                <div class="mt-7">
                    ...
                    @forelse($songArtists as $artist)
                        <p class="hover:underline hover:text-gray-600"><a
                                href="{{url('artists/'.$artist->id)}}">{{$artist->name}}</a></p>
                    @empty
                        NA
                    @endforelse
                </div>
